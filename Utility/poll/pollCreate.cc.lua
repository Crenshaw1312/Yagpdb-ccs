...
{{ $type := "multiple" }} {{/*<multiple/single>, default poll setting*/}}
...
{{ $poll := sdict 
	...
	"Author" (sdict "icon_url" (.User.AvatarURL "256") "url" (print "https://discord.com/channels/@me/" .User.ID) "name" .User.String)
	"Description" $display
	"Color" 0x4B0082
